...
''' % self.serverType
        ...
        # default case: look for pman_config.ini or pfioh_config.ini in the current working directory
        if path == '':
    ...
    def authorizeClientRequest(self, request):
        ...
        if token != '' and token != None:
            ...
            return False, (400, self.errorMessages[401], "Authentication Required!")
